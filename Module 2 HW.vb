    ...
    For each ws in Worksheets
        ...
        For i = 2 To ws.Cells(Rows.Count, 1).End(xlUp).Row
            ...
            If ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value Then
                ...
                'Apply conditional formatting to yearly change column https://learn.microsoft.com/en-us/office/vba/api/excel.interior.color
                If ws.Range("J" & main_table_row).Value > 0 Then
                    ' Set green fill for positive values
                    ws.Range("J" & main_table_row).Interior.Color = RGB(0, 255, 0)
                ElseIf ws.Range("J" & main_table_row).Value < 0 Then
                    ' Set red fill for negative values
                    ws.Range("J" & main_table_row).Interior.Color = RGB(255, 0, 0)
                End If
